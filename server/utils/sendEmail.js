...
const NO_REPLY_EMAIL = 'no-reply@InCrypto.gold';
const USER = 'no-reply@InCrypto.gold'
    ...
    const HTML_CONTENT = `
        ...
        <html>
            <body>
                ...
                >
                    <h3 style="color: #000;">
                        <img src="cid:logo_img" alt="InCrypto" style="width: 40px; margin-right: 10px;" />
                        Greetings,
                    </h3>
                    ...
                    <p style="color: #000;"><strong>Kindly note:</strong> Please be aware of phishing sites and always make sure you are visiting the official InCrypto website when entering sensitive data</p>
                    <p style="margin-top: 60px; text-align: center; color: #000; font-size: 12px;">
                        © 2023 InCrypto. All rights reserved.
                    </p>
                </div>
            </body>
        </html>
